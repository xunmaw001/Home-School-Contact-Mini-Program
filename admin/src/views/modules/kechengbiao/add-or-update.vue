<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="周数" prop="zhoushu">
          <el-input v-model="ruleForm.zhoushu" 
              placeholder="周数" clearable  :readonly="ro.zhoushu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="周数" prop="zhoushu">
              <el-input v-model="ruleForm.zhoushu" 
                placeholder="周数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengbiao = this.ruleForm.kechengbiao.replace(reg,'../../../phpu1613/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
