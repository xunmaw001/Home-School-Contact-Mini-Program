<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级位置" prop="banjiweizhi">
          <el-input v-model="ruleForm.banjiweizhi" 
              placeholder="班级位置" clearable  :readonly="ro.banjiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级位置" prop="banjiweizhi">
              <el-input v-model="ruleForm.banjiweizhi" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="班级介绍" prop="banjijieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.banjijieshao" label="班级介绍" prop="banjijieshao">
                    <span>{{ruleForm.banjijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
