<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴费编号" prop="jiaofeibianhao">
          <el-input v-model="ruleForm.jiaofeibianhao" 
              placeholder="缴费编号" clearable  :readonly="ro.jiaofeibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴费编号" prop="jiaofeibianhao">
              <el-input v-model="ruleForm.jiaofeibianhao" 
