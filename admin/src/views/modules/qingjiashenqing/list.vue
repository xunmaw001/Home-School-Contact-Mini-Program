        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="回来时间">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="qingjiatupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="请假图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.qingjiatupian">
                        <img :src="$base.url+scope.row.qingjiatupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          qingjiatupian: row.qingjiatupian,
