<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyetupian" label="作业图片" prop="zuoyetupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zuoyetupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提交期限" prop="tijiaoqixian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tijiaoqixian" 
                type="datetime"
                :readonly="ro.tijiaoqixian"
                placeholder="提交期限">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tijiaoqixian" label="提交期限" prop="tijiaoqixian">
              <el-input v-model="ruleForm.tijiaoqixian" 
                placeholder="提交期限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(reg,'../../../phpu1613/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
